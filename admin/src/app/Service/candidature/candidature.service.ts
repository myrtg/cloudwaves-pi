...
export class CandidatureService {
  ...
  getAllData(): Observable<Candidature[]> {
    return this.httpClient.get<Candidature[]> ('http://localhost:8083/candidature/retrieve-all-candidature');
  }

  delete(id:any) {
    return this.httpClient.delete('http://localhost:8083/candidature/delete-candidature/'+id);
  }
