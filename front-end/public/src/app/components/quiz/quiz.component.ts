...
export class QuizComponent {
  ...
  submitQuiz() {
    ...
    this.http.post<any>(`http://localhost:8080/Quiz/submit/${this.idQuiz}`, answersArray)
      .subscribe(
        (data) => {
          ...
          this.http.post<any>(`http://localhost:8080/Quiz/send/mouhanedakermi@gmail.com/${answer}`, answersArray)
            .subscribe(
              (data) => {
                // Handle successful response from backend
                console.log(data);
